package com.music.store.actions.data;

import com.music.store.daos.CustomerDAO;
import com.music.store.interfaces.SongsDAO;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import com.music.store.interfaces.SongsService;
import com.music.store.models.Customer;
...
public class SongsDataProvider extends ActionSupport {


    private static final Log log = LogFactory.getLog(SongsDataProvider.class);

    // Your result List
    private List<Songs> gridModel;
    ...
    public String execute() {
        ...
        records = songsService.getSongsCount();
        ...
        // Get Data from DAO
        gridModel = songsService.getSongs(from, to);
     ...
     */
    public List<Songs> getGridModel() {
        return gridModel;
    }
     ...
     */
    public void setGridModel(List<Songs> gridModel) {
